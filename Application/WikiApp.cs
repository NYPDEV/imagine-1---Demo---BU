...
namespace SocialRobot.Application
{
    ...
    {
        //SpeechSynthesizer srespeech = new SpeechSynthesizer();
        ...
        public async void AskPresidentOrPrimeMinister_Async(string input)
        {
            ...
            Speak.srespeech.SpeakAsync("Hold on.");
        ...
        private void askquestion(string question_asking)//yihao
        {
            ...
            try
            {
                ...
                Speak.srespeech.SpeakAsync("Is it " + wiki_answer);
            }
            catch
            {
                Speak.srespeech.SpeakAsync("Sorry, I can't find it, can you try another one please?");
            }
            //return wiki_answer;
